...
CREATE TYPE "public"."location_display_mode" AS ENUM('names', 'codes', 'mixed');--> statement-breakpoint
...
CREATE TABLE "users" (
	...
	"fio_username" varchar(100) DEFAULT '' NOT NULL,
	"preferred_currency" "currency" DEFAULT 'CIS' NOT NULL,
	"location_display_mode" "location_display_mode" DEFAULT 'names',
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "users_profile_name_unique" UNIQUE("profile_name")
);
--> statement-breakpoint
