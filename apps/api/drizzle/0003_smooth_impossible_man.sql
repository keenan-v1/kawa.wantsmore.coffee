...
ALTER TABLE "price_import_configs" ADD CONSTRAINT "pic_location_default_fk" FOREIGN KEY ("location_default") REFERENCES "public"."fio_locations"("natural_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "price_import_configs_auto_sync_idx" ON "price_import_configs" USING btree ("auto_sync");--> statement-breakpoint
